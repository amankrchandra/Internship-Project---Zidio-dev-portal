...
const JobSeekerSignup = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] to-[#1E40AF] text-white flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white/10 backdrop-blur-md p-8 rounded-xl shadow-lg border border-white/20">
        <h2 className="text-2xl font-bold mb-6 text-center">Join as a Job Seeker</h2>
        <form className="space-y-4">
          ...
          <input type="email" placeholder="Email" className="w-full p-2 bg-transparent border border-white/20 rounded text-white placeholder-gray-300" />
          ...
          <input type="text" placeholder="Skills (e.g., React, Java)" className="w-full p-2 bg-transparent border border-white/20 rounded text-white placeholder-gray-300" />
